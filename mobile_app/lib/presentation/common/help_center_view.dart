...
class HelpCenterView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CommonInfoView(
      ...
      subtitle: 'Find answers to your frequently asked questions and get support from our team.',
      children: [
        InfoContentHelpers.buildSectionTitle('FREQUENTLY ASKED QUESTIONS (FAQ)', colorScheme),
        _buildFAQItem(
        ...
        Text(
          ...
          style: AppTextStyles.body.copyWith(color: colorScheme.onSurface.withValues(alpha:0.75)),
        ),
        Text(
