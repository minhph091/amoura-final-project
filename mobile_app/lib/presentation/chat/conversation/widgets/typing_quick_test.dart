...
/// Quick test để verify typing indicator hoạt động
class TypingQuickTest extends StatefulWidget {
  const TypingQuickTest({super.key});

  @override
  State<TypingQuickTest> createState() => _TypingQuickTestState();
}

class _TypingQuickTestState extends State<TypingQuickTest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Typing Quick Test'),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            debugPrint('TypingQuickTest: Set typing to true');
                          },
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            debugPrint('TypingQuickTest: Set typing to false');
                          },
                          style: ElevatedButton.styleFrom(
