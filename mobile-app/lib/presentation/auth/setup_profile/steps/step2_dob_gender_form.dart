...
import '../../../../data/remote/auth_service.dart'; // Add this import
            ...
            AppButton(
              ...
              onPressed: () async {
                if (_formKey.currentState?.validate() ?? false) {
                  ...
                  // Gửi dữ liệu Step 2 đến API
                  if (vm.sessionToken != null) {
                    try {
                      await AuthService().updateProfileStep(
                        sessionToken: vm.sessionToken!,
                        step: 1, // Step 1 vì Step 2 trong logic
                        data: {
                          'dateOfBirth': DateUtil.formatDDMMYYYY(vm.dateOfBirth!),
                          'sex': vm.sex,
                        },
                      );
                    } catch (e) {
