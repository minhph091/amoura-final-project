            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    Messages and interactions may be retained for safety and
                    security purposes
                  </li>
                  <li>
                    Some information may be retained longer to comply with legal
                    obligations
                  </li>
                  <li>
                    When you delete your account, we will delete or anonymize
                    your information within a reasonable timeframe
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed">
                  When transferring data internationally, we use standard
                  contractual clauses approved by relevant authorities and
                  ensure that recipients provide adequate protection for your
                  information.
                </p>
              </section>
