...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gradient-elegant flex flex-col relative overflow-hidden">
      ...
      {/* Footer */}
      <footer className="bg-white/80 backdrop-blur-sm border-t border-gray-200/50 py-8 relative z-10">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-600">© 2025 Amoura. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
