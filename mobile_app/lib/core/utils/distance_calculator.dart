...
class DistanceCalculator {
  ...
  /// Get distance display text with proper formatting
  static String getDistanceText(double? lat1, double? lon1, double? lat2, double? lon2) {
    // Check if all coordinates are available and valid (not 0.0)
    if (!_isValidCoordinate(lat1) || !_isValidCoordinate(lon1) || 
        !_isValidCoordinate(lat2) || !_isValidCoordinate(lon2)) {
