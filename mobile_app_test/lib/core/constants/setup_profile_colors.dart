...
const List<List<Color>> setupProfileColor = [
  [Color(0xffF7B0EC), Color(0xffC2E9FB), Color(0xffF7F0FA)], // Step 1
  [Color(0xffF7B0EC), Color(0xffA8E1F9), Color(0xffE0D4FA)], // Step 2
  ...
  [Color(0xff7F50BC), Color(0xff009EE3), Color(0xffAA74D2)], // Step 10
];
