...
import 'date_of_birth_form.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<RegisterViewModel>(
      builder: (context, viewModel, child) {
        ...
        } else if (viewModel.showCompleteForm) {
          if (!viewModel.showDateOfBirthForm) {
            return CompleteRegistrationForm(viewModel: viewModel);
          } else {
            return DateOfBirthForm(viewModel: viewModel);
          }
        } else {
          return Form(
