...
Future<bool?> showDeactivateAccountDialog(
  ...
  return showConfirmDialog(
    context: context,
    title: localizations.translate('deactivate_account_title'),
    content: localizations.translate('deactivate_account_info'),
    confirmText: localizations.translate('deactivate_now'),
    ...
    additionalContent: _buildConfirmationCheckbox(
      context,
      viewModel,
      localizations.translate('deactivate_confirmation'),
    ),
    onConfirm:
