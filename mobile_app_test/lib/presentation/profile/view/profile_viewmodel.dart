...
class ProfileViewModel extends ChangeNotifier {
  ...
  Future<void> loadProfile() async {
    ...
    try {
      ...
      debugPrint('Profile loaded successfully: $profile');
      
      // Check appearance data specifically
      if (profile != null) {
        debugPrint('Appearance Data Check:');
        debugPrint('Body Type: ${profile!['bodyType']}');
        debugPrint('Height: ${profile!['height']}');
        
        // Validate appearance data structure
        if (profile!['bodyType'] != null) {
          debugPrint('Body Type Structure: ${profile!['bodyType'].runtimeType}');
          if (profile!['bodyType'] is Map) {
            debugPrint('Body Type Name: ${profile!['bodyType']['name']}');
          }
        }
      }
    } catch (e) {
      ...
      debugPrint('Error in loadProfile: $error');
    } finally {
